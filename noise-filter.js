...
module.exports.filterAccel = function filterAccel (val, prevVal) {
  if (val < prevVal - NP_ACCEL || val > prevVal - NP_ACCEL) return val
  if (val < prevVal - NPS_ACCEL || val > prevVal - NPS_ACCEL) { return (val + prevVal) / 2 }
...
module.exports.filterMag = function filterMag (val, prevVal) {
...
module.exports.filterGyro = function filterGyro (val) {
